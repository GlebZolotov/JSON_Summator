...
if [ "$1" -gt 1 ]; then
    ...
    gnome-terminal -- bash -c "${path_to_kafka}/bin/kafka-topics.sh --delete --zookeeper localhost:2181 --topic input_topic; ${path_to_kafka}/bin/kafka-topics.sh --create --topic input_topic --bootstrap-server localhost:9092"
    gnome-terminal -- bash -c "${path_to_kafka}/bin/kafka-topics.sh --delete --zookeeper localhost:2181 --topic output_topic; ${path_to_kafka}/bin/kafka-topics.sh --create --topic output_topic --bootstrap-server localhost:9092"
    # start python scripts
