...
rbar = mean(R);
% maximal MAD variance
gammaMAD = 0.003 + rand*0.017;
...
clear Gran RetG
% this is different for different types of problems
% MAD min
%commonParameters =
%CommonParametersMADmin(bTcoef,mu0,wmin,R,Gr,rbar,numax,numshares,T);
% MAD max
commonParameters = CommonParametersMADmax(wmin,R,Gr,rbar,numax,numshares,T,gammaMAD);
